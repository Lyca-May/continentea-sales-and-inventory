        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <form action="<?=site_url('LoginAccess/UpdateSupply')?>" method="POST">
                      <div class="form-group">
                        <input type="text" class="form-control" name="id" value="<?=$supplier['id']?>">
                      </div>
                      <div class="form-group">
                        <label >Supplier Name</label>
                        <input type="prodname" class="form-control" name="name" id="name" value="<?=$supplier['name']?>">
                      </div>

                      <div class="form-group">
                        <label >Company</label>
                        <input type="price" class="form-control" name="company" id="company" value="<?=$supplier['company']?>">
                      </div>

                      <div class="form-group">
                        <label >Address</label>
                        <input type="quantity" class="form-control" name="address" id="address" value="<?=$supplier['address']?>">
                      </div>

                      <div class="form-group">
                        <label >Contact Number</label>
                        <input type="quantity" class="form-control" name="contact_no" id="contact_no" value="<?=$supplier['contact_no']?>">
                      </div>
                      
                      <input type="submit" value="Add Product" class="btn btn-primary btn-user btn-block"> </input>
                    </form>
                    <br>
                    <br>
                </div>
