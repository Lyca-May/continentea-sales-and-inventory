...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
    ...
    <a href="<?=site_url('LoginAccess/addnewsupply')?>" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i
     class="fas fa-download fa-sm text-white-50"></i>+ Add Supply</a>
 </div>
<!-- DataTales Example -->
...
<h6 class="m-0 font-weight-bold text-primary"><h4>DataTables Supplies</h4></h6>
</div>
<div class="card-body">
                    ...
                    <?php foreach($supply as $sup):?>
                      ...
                      <td>
                          <form action="<?=site_url('LoginAccess/userdelete')?>"method="POST">
                              <input type="hidden" name="supply_id" value="<?=$sup['supply_id']?>">
