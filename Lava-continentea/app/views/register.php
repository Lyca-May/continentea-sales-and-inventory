...
.bg-gradient-primary {
  background-color: #4e73df;
  background-image: linear-gradient(180deg, #bb4f44 10%, #221f1f 100%);
...
.bg-register-image {
  background: url("https://hips.hearstapps.com/hmg-prod.s3.amazonaws.com/images/cup-of-latte-or-cortado-coffee-royalty-free-image-1608639937.?crop=1xw:0.99953xh;center,top&resize=480:*");
  background-position: center;
  background-size: cover;
}
...
body.sidebar-toggled footer.sticky-footer {
  width: 100%;
    ...
    <title>Continentea Cafe - Register</title>
                        ...
                        <div class="p-5">
                            ...
                            <form action="<?=site_url('User/register')?>" method="POST">
                                <div class="form-group row">
                                    ...
                                    <input type="text" class="form-control" name="name" placeholder="Please input your complete name">
                                    </div>
                                    <div class="col-sm-6">
                                    <input type="text" class="form-control" name="username" placeholder="Please input your username">
                                    </div>
                                </div>
                                <div class="form-group">
                                <input type="email" class="form-control" name="email" placeholder="Please input your email">
                                </div>
                                <div class="form-group">
                            ...
                            <div class="text-center">
                            <a href="<?=site_url('LoginAccess/index')?>">Already have an account? Login!</a>
                            <br>
                            <br>
                            <br>
                            <br>
...
<form action="<?=site_url('User/register')?>" method="POST">
   <h1>Register Here</h1>
    <h5>Please complete the details</h5>
        <div class="form-group">
          <label>Name:</label><br>
          <input type="text" class="form-control" name="name" placeholder="Please input your complete name">
        </div>
        ...
        <br>
        <br>
        <a href="<?=site_url('LoginAccess/index')?>">Already have an account</a>
    </form> -->