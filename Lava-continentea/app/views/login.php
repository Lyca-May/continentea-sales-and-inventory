...
<div class="row">
    ...
    <div class="col-sm-4"> -->
      <!-- start form -->
   <!-- <form action="<?=site_url('LoginAccess/access')?>" method="POST">
   <h1>Log-in</h1>
        ...
        <br>
        <br>
        <a href="<?=site_url('User/index')?>">Register?</a>
    </form> -->
...
.bg-login-image {
  background: url("https://www.dorchestercollection.com/wp-content/uploads/london-the-dorchester-parcafe-difference-coffee-company-portrait-872x1164.jpg");
...
body.sidebar-toggled footer.sticky-footer {
  width: 100%;
    ...
    <title>Continentea Cafe - Login</title>
                        ...
                        <div class="row">
                            ...
                            <br>
                                <div class="p-5">
                                    ...
                                    <form action="<?=site_url('LoginAccess/access')?>" method="POST" class="user">
                                        <div class="form-group">
                                    ...
                                    <hr>
                                    <div class="text-center">
                                    <a href="<?=site_url('User/index')?>">Create an Account!</a>
                                    </div>
                                    <br>
                            <br>
                            <br>
