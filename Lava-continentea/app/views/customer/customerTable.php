...
.bg-gradient-primary {
  background-color: #4e73df;
  background-image: linear-gradient(180deg, #AB5C4B 10%, #221f1f 100%);
...
<div id="content">
    ...
    <!-- End of Topbar -->
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
              <h1 class="h3 mb-0 text-gray-800">Manage Customer's Orders</h1>
              <a href="<?=site_url('Customer/addformCustomer')?>" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i
              class="fas fa-download fa-sm text-white-50"></i>+ Add Customer's Orders</a>
          </div>
          <br>
          <!-- DataTales Example -->
          ...
          <div>
            ...
            <h6 class="m-0 font-weight-bold text-primary"><h4>DataTables Orders</h4></h6>
            <div id="dataTable_filter" class="dataTables_filter">
              <label><input id="search" type="search" class="form-control form-control-sm" placeholder="Search" aria-controls="dataTable"></label></div>
                      </div>
            </div>
            <div class="card-body">
                ...
                <tbody>
                  <tr>
                    <?php foreach($customer as $cust):?>
                      ...
                      <td>
                          <form action="<?=site_url('Customer/Customerdelete')?>"method="POST">
