    ...
    <!-- End of Topbar -->
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        ...
                        <a href="<?=site_url('Prod/addprodlistform')?>" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i
                                    ...
                                    <tbody>
                                      <tr>
                                        <?php foreach($productlist as $list):?>
                                          ...
                                          <td><?=$list ['category'] ?></td> 
                                          <td>
                                              <form action="<?=site_url('Prod/deleteProdlist')?>"method="POST">
                                                  <input type="hidden" name="id" value="<?=$list['id']?>">
                                                  <input type="submit" class = "bg-primary text=light" value="Delete">
                                              </form>
                                          </td>
                                          <td>
                                              <form action="<?=site_url('Prod/Productlistupdate')?>"method="POST">
                                                  <input type="hidden" name="id" value="<?=$list['id']?>">
