        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <form action="<?=site_url('Prod/UpdateProdlist')?>" method="POST">
                      <div class="form-group">
                        <input type="text" class="form-control" name="id" value="<?=$products['id']?>">
                      </div>
                      <div class="form-group">
                        <label >Product name</label>
                        <input type="prodname" class="form-control" name="prodname" id="prodname" value="<?=$products['prodname']?>">
                      </div>
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="category" id="category" value="<?=$products['category']?>">
                      </div>
