...
.bg-gradient-primary {
  background-color: #4e73df;
  background-image: linear-gradient(180deg, #a75434 10%, #224abe 100%);
            ...
            <div id="content">
                ...
                <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item">
                           <a class="nav-link" href="<?=site_url('LoginAccess/index')?>">
                           <i class="fas fa-fw fa-table"></i>
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">Manage Customer</h1>
                    <form action="<?=site_url('Customer/UpdateCustomer')?>" method="POST">
                      ...
                      <div class="form-group">
                        ...
                        <input type="prodname" class="form-control" name="customer_name" id="customer_name" value="<?=$customer['customer_name']?>">
                      </div>
                      <div class="form-group">
                        <label >Product name</label>
                        <input type="prodname" class="form-control" name="product" id="product" value="<?=$customer['product']?>">
                      </div>
                      <div class="form-group">
                        <label >Price</label>
                        <input type="price" class="form-control" name="price" id="price" value="<?=$customer['price']?>">
                      </div>
                      <div class="form-group">
                        <label >Quantity</label>
                        <input type="quantity" class="form-control" name="quantity" id="quantity" value="<?=$customer['quantity']?>">
                      </div>
                      <div class="form-group">
                        <label >Total Price</label>
                        <input type="quantity" class="form-control" name="total_price" id="total_price" value="<?=$customer['total_price']?>">
                      </div>
                      
                      <input type="submit" value="Update Product" class="btn btn-primary btn-user btn-block"> </input>
                    </form>
                    <br>
                    <br>
                </div>
