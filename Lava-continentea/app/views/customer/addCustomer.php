        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class='card'>
                    <div class='card-body'>
                      <h1 class="h3 mb-2 text-gray-800 text-center">Manage Order</h1>
                      <br>
                      <form action="<?=site_url('Customer/addCustomer')?>" method="POST">
                        ...
                        <input type="submit" value="Add Customer" class="btn btn-primary btn-user btn-block"> </input>
                      </form>
                    </div>
                    </div>
