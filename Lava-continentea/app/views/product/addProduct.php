        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <form action="<?=site_url('Prod/addProdlist')?>" method="POST"> 
                         <div class="form-row">
                              <div class="col">
                                <br>
                              ...
                              <select class = "form-control" name="category">
                                  ...
                                  <option value="category">American Drinks</option>
                                  <option value="category">African Drinks</option>
                              </select>
                              ...
                              <label for="gender"></label>
                                ...
                                <?php foreach ($prod as $prods): ?> 
                                  <option value="<?= $prods['products']?>"> <?= $prods['products']?> </option>
                                  <?php endforeach; ?>
                                </select>
                                <br>
                            ...
                            <button type="submit" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm" ><i
                                class="fas fa-download fa-sm text-white-50" style="marginleft: 30rem"></i>Add Supply</button>
                                </div>
                        </form>
                    </div>
                    </div>
            ...
            <footer class="sticky-footer bg-white">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>Copyright &copy; ContinenTea Cafe Official Admin Website</span>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
