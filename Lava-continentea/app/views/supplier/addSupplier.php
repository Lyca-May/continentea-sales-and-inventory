        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <form action="<?=site_url('LoginAccess/addSupply')?>" method="POST">
                      <div class="form-group">
                        <label >Supplier name</label>
                        <input type="prodname" class="form-control" name="name" id="name" placeholder="Supplier Name">
                      </div>
                      <div class="form-group">
                        <label >Company</label>
                        <input type="price" class="form-control" name="company" id="company" placeholder="Company">
                      </div>
                      <div class="form-group">
                        <label >Address</label>
                        <input type="quantity" class="form-control" name="address" id="address" placeholder="Address">
                      </div>

                      <div class="form-group">
                        <label >Contact Number</label>
                        <input type="quantity" class="form-control" name="contact_no" id="contact_no" placeholder="Contact Number">
                      </div>
