        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <form action="<?=site_url('Supply/UpdateSupplyprod')?>" method="POST">
                      <div class="form-group">
                        <input type="text" class="form-control" name="supply_id" value="<?=$supply['supply_id']?>">
                      </div>
                      <div class="form-group">
                        <label >Product</label>
                        <input type="text" class="form-control" name="products" id="products" value="<?=$supply['products']?>">
                      </div>

                      <div class="form-group">
                        <label >Stocks</label>
                        <input type="text" class="form-control" name="stocks" id="stocks" value="<?=$supply['stocks']?>">
                      </div>

                      <div class="form-group">
                        <label >Supplier Name</label>
                        <input type="text" class="form-control" name="supplier_name" id="supplier_name" value="<?=$supply['supplier_name']?>">
                      </div>
